...
public class SelectionActivity extends Activity {
    ...
    private void initUIAndData() {
        ...
        mNameEditText.setText(getmTargetName());

        userIDTv=findViewById(R.id.userIDTv);
        userIDTv.setText("你的ID:"+mUserId);
    ...
    public void onClickChat(View v) {
        ...
        editor.putString("mTargetName",mTargetName);
        editor.commit();
    ...
    private void jumpToMessageActivity() {
        Intent intent = new Intent(this, ShowVrActivity.class);
